...
angular.module('main')
  .controller('ConfiguracionCtrl', function ($log, $scope, $localStorage,
    ...
    $scope.limpieza = function () {
      ...
      for (i = 0; i < $localStorage.frecuenciasActividadesMes.length; i++) {
        $localStorage.frecuenciasActividadesMes[i] = 0;
      }

      for (i = 0; i < $localStorage.frecuenciasActividadesSemana.length; i++) {
        $localStorage.frecuenciasActividadesSemana[i] = 0;
      }

      for (i = 0; i < $localStorage.frecuenciasEstadosDeAnimo.length; i++) {
